...
public class HighScorePanel extends JPanel{
    ...
    public HighScorePanel() {
        ...
        */
        ...
        backButton.setToolTipText("Go back to previous menu");
    ...
    public JLabel getMemberLabel(int index) {
        return this.membersLabels[index];
    }
    
    public JLabel[] getMembersLabelsArray() {
        return this.membersLabels;
    }
